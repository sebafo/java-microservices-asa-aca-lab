...
1. In your configuration repository replace the `application.yml` with the contents of [this application.yml](https://github.com/sebafo/java-microservices-asa-aca-lab/tree/main/config/05_application.yml) file. This file contains the following changes:
